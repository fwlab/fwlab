#ifndef FWLAB_MATERIAL_SUBSURFACE_MATERIAL_H
#define FWLAB_MATERIAL_SUBSURFACE_MATERIAL_H
#include <math/vec3.h>
#include <math/vec4.h>
...
namespace fwlab::material
{
	...
	public:
		...
		float getIOR() const;												 // not implemented
		void setIOR(float ior);												 // not implemented
		...
		void setSubsurfaceColor(filament::math::float3 subsurfaceColor);
		float getSubsurfacePower() const;
		void setSubsurfacePower(float subsurfacePower);
