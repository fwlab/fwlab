...
Texture::Texture(uint32_t width, uint32_t height, filament::Texture::Format format) :
	Texture(width, height, gl::utils::ImageUtils::textureFormatToInternalFormat(format))
{
